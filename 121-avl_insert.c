...
avl_t *avl_insert_recursive(avl_t **tree, avl_t *parent,avl_t **new, int 
		value);
/**
...
avl_t *avl_insert(avl_t **tree, int value)
{
	...
	avl_insert_recursive(tree, *tree, &n, value);
	return (n);
}

/**
 * avl_insert_recursive - A functio that inserts a value into an AVL tree recursively.
 * @tree: A double pointer to the root node of the AVL tree to insert into.
 * @parent: The parent node of the current working node.
 * @new: A double pointer to store the new node.
 * @value: The value to insert into the AVL tree.
 * Return: A pointer to the new root after insertion, or NULL
 */
 ...
 * @tree: A pointer to the node of the tree to measure the balance factor.
 ...
 * @tree: The node of the tree to measure the height.
